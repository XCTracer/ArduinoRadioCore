/* 
 * Simple Ping-Pong for a GFSK Radio/Modem
 *    
...
uint8_t sync_word[] = { 0x99, 0x95, 0xa6, 0x9a, 0x65 };
...
void setup(void) {
    ...
    radio.configure_gfsk(868200, 100000, 50000, sync_word, sizeof(sync_word));
...
const uint8_t message[] = "GFSK Test Message";
